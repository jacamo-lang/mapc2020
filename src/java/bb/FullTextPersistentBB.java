...
import jason.bb.TextPersistentBB;
 ...
 */
public class FullTextPersistentBB extends TextPersistentBB {
    private static Logger logger = Logger.getLogger(TextPersistentBB.class.getName());

    private File file = null;

    public FullTextPersistentBB() { }
    public FullTextPersistentBB(BeliefBase next) {
        super(next);
    }
